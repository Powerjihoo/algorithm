...
from model.prediction.vae import VAE
from api_server.models.models import ModelSetting

model_tag_value_queue = ModelTagValueQueue()


class VAEManager(PredModelManagerBase, metaclass=SingletonInstance):
    # Observer
    def __init__(self):
        self.cnt_calc = 0
    ...
    def define_prediction_model(
        ...
        return VAE(model_info.modelname, tagnames, targettagnames, custom_base_path=custom_base_path, version = model_info.version)
