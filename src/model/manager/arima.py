...
class ARIMAManager(PredModelManagerBase, metaclass=SingletonInstance):
    ...
    def define_prediction_model(
        ...
        return ARIMA(modelname=model_info.modelname, tagname=tagnames, custom_base_path=custom_base_path)
