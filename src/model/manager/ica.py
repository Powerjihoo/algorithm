...
from model.prediction.ica import ICA
...
class ICAManager(PredModelManagerBase, metaclass=SingletonInstance):
    # Observer
    def __init__(self):
        self.cnt_calc = 0
    ...
    def define_prediction_model(
        ...
        return ICA(model_info.modelname, tagnames, targettagnames, custom_base_path=custom_base_path, version = model_info.version)
